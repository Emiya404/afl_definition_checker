...
cd $2
make clean
make all FUZZER=NSFUZZ TARGET=LIVE555
...
patch -p1 <$2/../compile_scripts/live555/nsfuzz_fuzzing.patch
export MANNUAL_SYNC=1
export NSFUZZ_TRACE_STATE=1
export ANALYZER_SVFILE_PATH=$2/../compile_scripts/live555/static_out
#export NSFUZZ_PARSE_ANNOTATION=1
./genMakefiles linux && \
...
cp -r $2/../compile_scripts/live555/in-rtsp/ ${FUZZ_ARENA}/live555
